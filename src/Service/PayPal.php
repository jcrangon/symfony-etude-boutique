...
class PayPal
{
  ...
  public function __construct(
    ...
    $this->debug = $_ENV['PAYPAL_DEBUG'];
    $this->endpoint = $_ENV['PAYPAL_API'];
  ...
  public function handlePayment(Order $order, array $requestData): bool
  {
    ...
    if (
      $this->paidRightAmount($paypalOrder, $order)
  ...
  public function paidRightAmount(array $paypalOrder, Order $order): bool
  {
    ...
    if ((int) $paypalOrder['purchase_units'][0]['amount']['value'] !== $order->getTotalAmountTTC()) {
