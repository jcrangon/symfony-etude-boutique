 ...
 */
final class Version20230423123725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment_method (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`, img VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, width VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`, type VARCHAR(3) NOT NULL COLLATE `utf8mb4_general_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
