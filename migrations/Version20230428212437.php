 ...
 */
final class Version20230428212437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE status status VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE payment_method payment_method INT NOT NULL COLLATE `utf8mb4_general_ci`');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE status status INT NOT NULL, CHANGE payment_method payment_method INT NOT NULL');
